        ...
        <div class="hidden md:block" id="nav-content">
            <ul class="list-reset flex items-center justify-end">
                <li class="mr-3 py-2 lg:py-0">
                    <a class="btn-pilih flex items-center gap-2 rounded bg-green-600 px-3 py-2 text-xs font-bold uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-green-800 hover:shadow-lg" href="/undangan/{{ Auth::user()->id }}" target="_blank">
