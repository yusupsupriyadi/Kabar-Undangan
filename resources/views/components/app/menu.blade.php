        ...
        <ul class="list-reset">
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="#" class="{{ $active === 'halaman-utama' ? 'hover:text-purple-500 lg:border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    ...
                    <p class="pb-1 text-sm font-bold text-gray-900 md:pb-0">Halaman Utama</p>
                </a>
            </li>
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="#" class="{{ $active === 'pengaturan-web' ? 'hover:text-purple-500 lg:border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                    ...
                    <p class="pb-1 text-sm md:pb-0">Pengaturan Undangan</p>
                </a>
            </li>
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="#" class="{{ $active === 'informasi-acara' ? 'hover:text-purple-500 lg:border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
            ...
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="#" class="{{ $active === 'mempelai-pria' ? 'hover:text-purple-500 lg:border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
            ...
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="#" class="{{ $active === 'mempelai-wanita' ? 'hover:text-purple-500 lg:border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
            ...
            <p class="py-2 text-base font-bold text-gray-700 pt-4 pl-4 lg:pl-0">Fitur Premium</p>
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="#" class="{{ $active === 'mempelai-wanita' ? 'hover:text-purple-500 lg:border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" />
            ...
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="#" class="{{ $active === '' ? 'hover:text-purple-500 lg:border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
