<div id="menu-navigation" class="w-full pt-16 text-xl leading-normal text-gray-800 md:pt-4 lg:w-1/5">
    ...
    <div class="z-20 mt-0 hidden h-64 w-full overflow-y-auto overflow-x-hidden border border-gray-400 bg-white shadow lg:block lg:h-auto lg:overflow-y-hidden lg:border-transparent lg:bg-transparent lg:shadow-none" style="top:5em;" id="menu-content">
        <ul class="list-reset">
            ...
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="/cerita-cinta" class="{{ $active === 'cerita-cinta' ? 'hover:text-purple-500 border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
            ...
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="/gallery" class="{{ $active === 'gallery' ? 'hover:text-purple-500 border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" />
            ...
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="/kado-nikah" class="{{ $active === 'kado-nikah' ? 'hover:text-purple-500 border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" />
            ...
            <li class="py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="/kirim-undangan" class="{{ $active === 'kirim-undangan' ? 'hover:text-purple-500 border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <p class="pb-1 text-sm md:pb-0">Kirim Undangan</p>
                </a>
            </li>
            <li class="hidden py-2 hover:bg-purple-100 md:my-0 lg:hover:bg-transparent">
                <a href="/setting-tema" class="{{ $active === 'setting-tema' ? 'hover:text-purple-500 border-purple-500 lg:hover:border-purple-500' : 'hover:text-purple-500 lg:hover:border-gray-400' }} flex items-center gap-2 border-l-4 border-transparent pl-4 align-middle text-gray-700 no-underline">
                    <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" />
    ...
    <div class="flex justify-end md:hidden">
        <a class="btn-pilih mt-4 flex items-center gap-2 rounded bg-green-600 px-3 py-2 text-sm font-bold uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-green-800 hover:shadow-lg" href="{{ route('subdomain', ['subdomain' => Auth::user()->name]) }}">
