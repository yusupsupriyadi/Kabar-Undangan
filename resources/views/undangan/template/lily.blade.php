...
<main class="m-auto bg-[#FAEFEB] text-[#614425]">
                ...
                <table>
                    <tbody class="scale-110">
                        ...
                        <tr class="font-serif text-sm font-bold uppercase">
                            <td>
                                <div class="w-20 border-y border-[#614425] py-1">{{ \Carbon\Carbon::createFromFormat('d/m/Y', $data['setting_resepsi_api']['tanggal'])->locale('id')->isoFormat('dddd') }}</div>
                            </td>
                            <td class="px-2 text-6xl font-thin">{{ \Carbon\Carbon::createFromFormat('d/m/Y', $data['setting_resepsi_api']['tanggal'])->format('d') }}</td>
                            <td>
                                <div class="w-20 border-y border-[#614425] py-1">
    ...
    <section class="header bg-[url('/public/images/bg/bg-lily-mobile.webp')] bg-cover">
        <div class="container mx-auto max-w-xl text-center">
            ...
            <section class="text-md mt-4 scale-90 rounded-xl bg-[#614425] p-3 font-sans text-white md:scale-100">
    ...
    <div class="bg-[url('/public/images/bg/bg-2-lily.webp')] bg-contain md:bg-cover">
        ...
        <section class="container mt-4 items-center justify-evenly md:flex">
            <div class="w-auto">
                ...
                @if ($data['mempelai_wanita_api']['instagram'] !== 'null' && $data['mempelai_wanita_api']['instagram'] !== null)
                    <a data-aos="fade-right" data-aos-duration="2000" title="instagram mempelai wanita" href="https://www.instagram.com/{{ $data['mempelai_wanita_api']['instagram'] }}/" target="blank" class="mx-auto mt-4 flex max-w-[8rem] items-center justify-center gap-1 rounded-xl bg-[#614425] py-2">
            ...
            <div class="mt-12 w-auto md:mt-0">
                ...
                @if ($data['mempelai_pria_api']['instagram'] !== 'null' && $data['mempelai_pria_api']['instagram'] !== null)
                    <a title="instagram mempelai pria" data-aos="fade-left" data-aos-duration="2000" href="https://www.instagram.com/{{ $data['mempelai_pria_api']['instagram'] }}/" target="blank" class="mx-auto mt-4 flex max-w-[8rem] items-center justify-center gap-1 rounded-xl bg-[#614425] py-2">
                        <svg class="h-4 w-4 text-white" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <rect x="4" y="4" width="16" height="16" rx="4" />
                            <circle cx="12" cy="12" r="3" />
    ...
    <div class="bg-[url('/public/images/bg/bg-3-lily.webp')] bg-cover">
        <section class="container mx-auto mt-28 max-w-4xl pb-10">
            ...
            <div class="mt-12 justify-center gap-6 md:flex">
                <div data-aos="zoom-in" data-aos-duration="1000" class="relative mt-6 flex items-start justify-between rounded-xl border-2 border-b-4 border-[#614425] bg-[#F0DAD1] p-4 sm:p-6 md:mt-0 lg:p-8" href="#">
                    <div class="mx-auto">
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" class="relative mt-8 flex items-start justify-between rounded-xl border-2 border-b-4 border-[#614425] bg-[#F0DAD1] p-4 sm:p-6 md:mt-0 lg:p-8" href="#">
                    <div class="mx-auto">
                        <h3 class="text-center font-masthina text-4xl font-bold">
                            Resepsi
                        </h3>
    ...
    <div class="bg-[url('/public/images/bg/bg-4-lily.webp')] bg-cover">
                        ...
                        @foreach ($data['cerita_cinta_api'] as $key => $val)
                                ...
                                <div class="flex md:contents">
                                    <div class="relative col-start-5 col-end-6 mr-10 md:mx-auto">
                                        <div class="flex h-full w-6 items-center justify-center">
                                            <div class="pointer-events-none h-full w-1 bg-[#614425]"></div>
                                        </div>
                                        <div class="absolute top-1/2 -mt-3 h-6 w-6 rounded-full bg-[#614425] shadow"></div>
                                    </div>
                                    <div class="col-start-6 col-end-10 my-4 mr-auto rounded-xl bg-[#614425] p-4 shadow-md" data-aos="fade-left" data-aos-duration="2000">
                            ...
                            @else
                                <div class="flex flex-row-reverse md:contents">
                                    <div class="col-start-1 col-end-5 my-4 ml-auto rounded-xl bg-[#614425] p-4 shadow-md" data-aos="fade-right" data-aos-duration="2000">
                                        <div class="flex items-center gap-1">
                                            <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                <rect x="4" y="5" width="16" height="16" rx="2" />
    ...
    <section class="container mx-auto mt-20 max-w-5xl">
        @if ($data['vip'] === true || $data['vip'] === 'true')
            <div data-aos="zoom-in" data-aos-duration="1000" class="rounded-xl border-2 border-b-4 border-[#614425] bg-[#F0DAD1] p-4 py-8">
                ...
                <section class="mt-4">
                    @foreach ($data['kado_nikah_api'] as $key => $value)
                        <div class="mt-6 text-center text-sm">
                            ...
                            <button class="btn-copy mt-2 rounded-xl bg-[#614425] px-4 py-2 text-xs font-semibold text-white" data-wallet="{{ $value['no_wallet'] }}" data-key="{{ $key }}">
    ...
    <div class="bg-[url('/public/images/bg/bg-4-lily.webp')] bg-cover">
        <section class="container mx-auto mt-20 max-w-4xl">
            ...
            <div class="mx-auto mb-0 mt-6 max-w-xl space-y-4 rounded-lg bg-[#614425] p-12 shadow-md" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                <div>
                    <div class="relative">
                ...
                <button class="{{ $data['name'] === 'demo' ? 'btn-demo' : 'btn-send' }} block w-full rounded-lg bg-[#F0DAD1] px-5 py-3 font-sans text-lg font-medium text-white">
                    Kirim Ucapan
                </button>
        </section>
    </div>
    ...
    <footer class="mt-20 rounded-tr-full border-t-4 border-[#614425] bg-[#614425] pl-4 text-left text-white">
