...
<main class="m-auto bg-[#222222] text-[#ECB751]">
    <section class="header opening mx-auto bg-[url('/public/images/bg/bg-blackgold-mobile.webp')] bg-cover" id="opening">
    ...
    <section class="header bg-[url('/public/images/bg/bg-blackgold-mobile.webp')] bg-cover">
    ...
    <div class="bg-[url('/public/images/bg/bg-2-blackgold.webp')] bg-contain md:bg-cover">
    ...
    <div class="bg-[url('/public/images/bg/bg-3-blackgold.webp')] bg-cover">
        <section class="container mx-auto mt-28 max-w-4xl pb-10">
            ...
            <div class="mt-12 justify-center gap-6 md:flex">
                <div data-aos="zoom-in" data-aos-duration="1000" class="relative mt-6 flex items-start justify-between rounded-xl border-2 border-b-4 border-[#ECB751] bg-[#171717] p-4 sm:p-6 md:mt-0 lg:p-8" href="#">
                    <div class="mx-auto">
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" class="relative mt-8 flex items-start justify-between rounded-xl border-2 border-b-4 border-[#ECB751] bg-[#171717] p-4 sm:p-6 md:mt-0 lg:p-8" href="#">
                    <div class="mx-auto">
                        <h3 class="text-center font-masthina text-4xl font-bold">
                            Resepsi
                        </h3>
    ...
    <div class="bg-[url('/public/images/bg/bg-4-blackgold.webp')] bg-cover">
    ...
    <footer class="mt-20 rounded-tr-full border-t-4 border-black bg-[#ECB751] pl-4 text-left text-white">
