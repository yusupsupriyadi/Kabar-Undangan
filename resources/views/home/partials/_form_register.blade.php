<div class="card indicator mt-4 w-full max-w-sm flex-shrink-0 bg-base-100 shadow-2xl lg:mt-0">
    ...
    <div class="card-body">
        ...
        <div class="form-control">
            ...
            <input id="phone" type="text" placeholder="phone" class="input-bordered input" />
            <a href="/login" class="link-hover label-text-alt link mt-4 text-right text-blue-600">Masuk ?</a>
        </div>
