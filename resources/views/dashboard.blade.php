...
@section('content')
    {{-- <a href="/complete-register" class="btn btn-primary">Lengkapi Data Pernikahan</a> --}}
            ...
            <div class="border-rounded mt-6  border border-gray-400 bg-white p-8 leading-normal text-gray-900 lg:mt-0 lg:w-4/5">
                ...
                <main class="py-12">
                    <section class="grid gap-8 lg:grid-cols-5">
                        ...
                        <x-app.card-menu paint="indicator">
                            <x-slot name='icon'>
                                <svg class="h-10 w-10" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
                ...
                {{-- <x-app.blockquote message="Cek kembali data yang kamu masukan. Pastikan semua sudah benar dan yakin." /> --}}
                <x-app.testimoni-bar />
            </div>
        ...
        <footer class="border-t border-gray-400 bg-white shadow">
            <div class="container mx-auto flex py-8">
                <div class="mx-auto flex  flex-wrap">
                    ...
                    <div class="flex  lg:w-1/2 lg:justify-end lg:text-right">
                        <div class="px-8">
                            <h3 class="font-bold text-gray-900">Social</h3>
                            <ul class="list-reset items-center pt-3 text-sm">
                                <li>
                                    <a class="inline-block py-1 text-gray-600 no-underline hover:text-gray-900 hover:underline" href="#">Add social links</a>
                                </li>
                            </ul>
                        </div>
                    </div>
